...
class ClusteredHit:
    ...
    def GetPosition(self):
        return ClusteredHit.CVec(self._position)
...
# (viii)
def clustering_hits_byangle(hits, hit_in_previous_layer):
    if len(hits) < 2:
    ...
    def FindVertices(self, RE, theta, phi, polarization):
        ...
        for candidate in RESEs:
            ...
            if polarization == True:
                ...
                interlayer_distance = VF.interlayer_distance # change to use DetectorList so that AstroPix is a command line input and then get struc pitch form there -- in revan this will be a gui selection (see MERTrack line 164)
                #print(f"interlayer spacing:", {interlayer_distance}) -> does correctly print 1.5 for AMEGO-X
            ...
            if selected_distance == 1:
                ...
                if init_dir is not None:
                    ...
                    clustered = clustering_hits_byangle(selected_layer_hits, candidate_position)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if Vertices:
            ...
            if top_vertex.gamma_dir is not None:
